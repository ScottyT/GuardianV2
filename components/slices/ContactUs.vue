<template>
	<div class="form-wrapper">
		<form class="form-wrapper__form form--contact" method="POST" @submit.prevent="submitForm">
			...
			<p v-if="errors.length"><strong>Please correct the follwing errors: </strong></p>
			<ul>
			...
			<label>Email</label>
			<input class="form__input" v-model="email" name="address" type="email" value="" />
			<label>Message</label>
			<textarea class="form__input" v-model="message" name="message" type="text" value="" />
